...
describe('Tests for POST', () => {
  ...
  it('should allow user to fill out form', () => {
    ...
    cy.get(':nth-child(3) > h3').contains('Amazing Tree')
    cy.get(':nth-child(3) > a').contains('http://localhost:3001/useshorturl/28')
    cy.get(':nth-child(3) > p').contains('https://images.unsplash.com/photo-1695790952932-386b9d66c18a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDZ8NnNNVmpUTFNrZVF8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60')
  })
})
